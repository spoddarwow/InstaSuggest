...
import net.semanticmetadata.lire.indexing.fastmap.ArrayFastmapDistanceMatrix;
import net.semanticmetadata.lire.indexing.fastmap.FastMap;
import net.semanticmetadata.lire.indexing.fastmap.FastmapDistanceMatrix;
import net.semanticmetadata.lire.indexing.fastmap.FeatureDistanceCalculator;
import net.semanticmetadata.lire.indexing.fastmap.NocacheFastmapDistanceMatrix;
import net.semanticmetadata.lire.indexing.fastmap.SavedPivots;
